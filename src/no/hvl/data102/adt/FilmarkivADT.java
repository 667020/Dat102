...
public interface FilmarkivADT {
	 ...
	 * @return film med git nr. Om nr ikke finnes. returneres null.
	 */
	Film finnFilm(int nr); 
	
	/**
	 * Legger til en ny film.
	 * @param nyFilm lager et nytt objekt Film
	 */
	void leggTilFilm(Film nyFilm); 
	/**
	 * Sletter Film objekt basert på filmnr
	...
	/**
	 * soker og henter filmer med en gitt delstreng i filmprodusent
	 * @param delstreng
	 * @return
	 */
